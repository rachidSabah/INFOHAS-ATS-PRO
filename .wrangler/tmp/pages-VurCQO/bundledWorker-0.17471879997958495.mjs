...
var ce = /* @__PURE__ */ __name((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !oe.call(e, n) && n !== r && H(e, n, { get: /* @__PURE__ */ __name(() => t[n], "get"), enumerable: !(s = ae(t, n)) || s.enumerable });
  return e;
}, "ce");
var F = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e)), "F");
var g;
var u = M(() => {
  g = { collectedLocales: [] };
});
...
function pe(e, t) {
  ...
  if (!h && !t?.domains?.includes(o.hostname) && !t?.remotePatterns?.find((b) => he(o, b))) return;
  let p = e.headers.get("Accept") ?? "", y = t?.formats?.find((b) => p.includes(b))?.replace("image/", "");
...
function xe() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await X(r), s) ? s : (be(r), e(r));
  };
}
__name(xe, "xe");
async function we(e) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.17471879997958495.mjs.map
