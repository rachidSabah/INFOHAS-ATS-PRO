  ...
  const renderCopilotChat = (heightClass: string) => {
    ...
    return (
      <div className={`flex flex-col ${heightClass} border border-border dark:border-slate-800 rounded-xl bg-gradient-to-b from-card to-background shadow-md overflow-hidden relative group`}>
        ...
        {!isInterviewActive && !autopilotRunning && (
          <div className="px-2 pt-2 flex items-center gap-1.5 overflow-x-auto scrollbar-none shrink-0 border-t border-border/40 bg-slate-50/20 dark:bg-slate-900/10">
            ...
            <div className="flex items-center gap-1.5 pb-2">
              <button
                onClick={() => sendMessage("Rewrite the professional summary or experience bullets to make them highly punchy, action-oriented, and outcome-focused.")}
              ...
              <button
                onClick={() => sendMessage("Analyze my experience bullets and rewrite them to include placeholders [X%] or [Y] where metrics can be added.")}
              ...
              <button
                onClick={() => sendMessage("Polish my resume summary and experience bullet points specifically for a Cabin Crew / Luxury Hospitality role, emphasizing safety, premium guest experience, and presentation standards.")}
              ...
              <button
                onClick={() => sendMessage("Condense my resume text to make it extremely concise and fit neatly onto a single A4 page.")}
                className="text-[10px] whitespace-nowrap px-2.5 py-1 rounded-full border border-rose-200 dark:border-rose-800 bg-rose-50/50 dark:bg-rose-950/20 text-rose-700 dark:text-rose-300 hover:bg-rose-100 dark:hover:bg-rose-950/50 font-medium shadow-sm transition active:scale-95 cursor-pointer flex items-center gap-1"
              >
