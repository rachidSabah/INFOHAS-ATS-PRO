...
export const SEED_PROVIDERS: AIProvider[] = [
  {
    ...
    isFallback: true,
    isBuiltIn: true,
    allowedForRegularUsers: true, // ✅ Regular users can use Puter.js (free, user-authenticated)
    timeout: 30000,
    maxTokens: 4096,
    temperature: 0.7,
    retryAttempts: 2,
  ...
  },
  {
    ...
    retryAttempts: 2,
    rateLimitPerMinute: 60,
    modelName: "opencode/gpt-4o-mini",
    enabledModels: ["opencode/gpt-4o-mini", "opencode/claude-3.5-sonnet", "opencode/llama-3.3-70b", "opencode/qwen-2.5-72b"],
    streamingEnabled: true,
    supportsFunctionCalling: true,
    authType: "bearer",
    costPerInputToken: 0,
  ...
  },
  {
    ...
    retryAttempts: 2,
    rateLimitPerMinute: 60,
    modelName: "zencode/free-1",
    enabledModels: ["zencode/free-1", "zencode/flash-1", "zencode/pro-1"],
    streamingEnabled: true,
  ...
  },
  {
    ...
    isFallback: true,
    isBuiltIn: true,
    allowedForRegularUsers: true, // ✅ Built-in fallback — always available
    timeout: 20000,
    maxTokens: 4096,
    temperature: 0.7,
    retryAttempts: 1,
  ...
  },
  {
    ...
    isActive: false,
    isBuiltIn: false,
    allowedForRegularUsers: false, // ❌ Super-admin-only by default
    timeout: 30000,
    maxTokens: 4096,
    temperature: 0.7,
    retryAttempts: 3,
  ...
  {
    id: "p_anthropic",
    name: "Anthropic Claude (user-supplied)",
    type: "claude",
