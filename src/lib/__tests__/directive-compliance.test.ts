...
function makeConfig(overrides: Partial<OptimizerDirectiveConfig> = {}): OptimizerDirectiveConfig {
  return {
    ...
    agentDirectives: {
      ...
      education: { formatOnly: true, stripSectionHeaders: true } as any,
      languages: { formatOnly: true, stripSectionHeaders: true } as any,
      ...
      additionalInfo: { formatOnly: true } as any,
    },
    ...overrides,
  };
}
